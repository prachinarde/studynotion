...
import { Autoplay, FreeMode, Pagination } from "swiper/modules"; // Updated import for modules
    ...
    <div className="text-white">
      <div className="my-[50px] h-[184px] max-w-maxContentTab lg:max-w-maxContent">
        <Swiper
          ...
          modules={[FreeMode, Pagination, Autoplay]} // Ensure correct usage of modules
          className="w-full"
        >
